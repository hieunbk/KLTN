...
class UserProfile(AbstractUser):
    ...
    identity_num = models.CharField(max_length=15, null=True)
    email = models.CharField(max_length=100)
    mobile_number = models.CharField(max_length=10, null=True)
    country = models.CharField(max_length=50, null=True)
    address = models.CharField(max_length=100, null=True)
    province_info = models.CharField(max_length=50, null=True)
    district_info = models.CharField(max_length=50, null=True)
    ward_info = models.CharField(max_length=50, null=True)
...
class LogSearch(models.Model):
    ...
    real_estate_type = models.IntegerField(default=0, null=False)
